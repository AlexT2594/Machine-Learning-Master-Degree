...
def cnn_model_fn(features, labels, mode):
    ...
    # Output Tensor Shape: [batch_size, 240, 800, 32]
    ...
    # Input Tensor Shape: [batch_size, 240, 800, 32]
    ...
    # Output Tensor Shape: [batch_size, 120, 400, 64]
    ...
    # Input Tensor Shape: [batch_size, 120, 400, 64]
    # Output Tensor Shape: [batch_size, 60, 200, 64]
    pool2 = tf.layers.max_pooling2d(inputs=conv2, pool_size=[2, 2], strides=2)

    # Convolutional Layer #3
    # Computes 128 features using a 5x5 filter.
    # Padding is added to preserve width and height.
    # Input Tensor Shape: [batch_size, 60, 200, 64]
    # Output Tensor Shape: [batch_size, 60, 200, 128]
    ...
    # Pooling Layer #3
    # Second max pooling layer with a 2x2 filter and stride of 2
    # Input Tensor Shape: [batch_size, 60, 200, 128]
    # Output Tensor Shape: [batch_size, 30, 100, 128]
    ...
    # Padding is added to preserve width and height.
    # Input Tensor Shape: [batch_size, 30, 100, 128]
    # Output Tensor Shape: [batch_size, 30, 100, 256]
    ...
    # Pooling Layer #4
    # Second max pooling layer with a 2x2 filter and stride of 2
    # Input Tensor Shape: [batch_size, 30, 100, 256]
    # Output Tensor Shape: [batch_size, 15, 50, 256]
    pool4 = tf.layers.max_pooling2d(inputs=conv4, pool_size=[
                                    2, 2], strides=2)

    # Convolutional Layer #5
    # Computes 256 features using a 5x5 filter.
    # Padding is added to preserve width and height.
    # Input Tensor Shape: [batch_size, 15, 50, 256]
    # Output Tensor Shape: [batch_size, 15, 50, 256]
    ...
    # Second max pooling layer with a 2x2 filter and stride of 2
    # Input Tensor Shape: [batch_size, 15, 50, 256]
    # Output Tensor Shape: [batch_size, 7, 25, 256]
    pool5 = tf.layers.max_pooling2d(inputs=conv5, pool_size=[
                                    2, 2], strides=2)

    # Flatten tensor into a batch of vectors
    # Input Tensor Shape: [batch_size, 7, 25, 256]
    # Output Tensor Shape: [batch_size, 7 * 25 * 256]
    pool5_flat = tf.reshape(pool5, [-1, 7 * 25 * 256])
    ...
    dense = tf.layers.dense(
        inputs=pool5_flat, units=1024, activation=tf.nn.relu)
